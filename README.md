# What does this do?
This is a VS Code extension (Better Nix Syntax). It highlights your nix code better, including the code inside `shellHook`s. If your theme is good, it should also color the nix code itself better. I'd recommended Atom One Dark, Tokyo Night, Cobalt Next, Bearded Theme (tons of variants), Noctis, XD Theme.
